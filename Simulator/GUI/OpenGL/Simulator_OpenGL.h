...
namespace SPH
{
	...
	protected:
		...
		static Shader m_shader_regions;
	...
	public:
		...
		static void pointRegionShaderBegin(Real particleRadius, const Vector3r* particlePositions, const unsigned int *particleLevels, const unsigned int *particleBorderLevels);
